...
public class CostomerRepository {
    ...
    private static final String FIND_BY_PET = "select c from Costomer c where :pet member of c.pets";
    ...
    public Costomer findCostomerByPet(Pet pet){
        return entityManager
                .createQuery(FIND_BY_PET, Costomer.class)
